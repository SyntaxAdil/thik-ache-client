    ...
    <div className="w-full space-y-5 select-none">
      <div className="flex flex-col md:flex-row gap-3 items-center justify-between w-full">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
          {/* Category Dropdown (Updated based on common help types) */}
          <Select
          ...
          {/* Status Dropdown (Aligned with Mongoose Schema) */}
          <Select
            value={currentStatus}
      ...
      {hasActiveFilters && (
        <div className="flex flex-wrap items-center gap-2 pt-1">
          {/* Tags remain same but logic updated to match new status values */}
          <button
          ...
          {currentStatus && (
            ...
            >
              {currentStatus} <X className="h-3 w-3" />
            </button>
          )}
          {/* ... Other tags ... */}
          <button
